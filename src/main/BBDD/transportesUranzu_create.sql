...
ALTER TABLE VIAJE_CAMIONES_CAMIONEROS ADD CONSTRAINT VIAJE_CAMIONES_CAMIONEROS_PK PRIMARY KEY (CAMIONERO,MATRICULA,VIAJE);
...
ALTER TABLE PAQUETES ADD CONSTRAINT PAQUETES_VIAJES FOREIGN KEY (VIAJE) REFERENCES VIAJES(ID);
...
ALTER TABLE VIAJE_CAMIONES_CAMIONEROS ADD CONSTRAINT VIAJES_FK FOREIGN KEY (VIAJE) REFERENCES VIAJES(ID);

/*Checks*/
ALTER TABLE PAQUETES ADD CONSTRAINT REMITENTE_DESTINATARIO_DIF  CHECK (REMITENTE != DESTINATARIO);
