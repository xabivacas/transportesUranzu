		...
		<table class="table">
					...
					<c:forEach items="${viajes}" var="viaje" >
						<tr>
							...
							<td>
								<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal${viaje.id }">
							...
							<td><a href="DestroyCamion?matricula=${viaje.id}"> <svg
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <form action="UpdateCamion" method="post">
						        	...
						        	<input type="hidden" value="${viaje.id }" name="matriculaMod" aria-describedby="nombreMod">
								  <div class="mb-3">
								    <label for="Marca" class="form-label">Origen</label>
								  ...
								  <div class="mb-3">
								    <label for="Modelo" class="form-label">Destino</label>
								    <input type="text" class="form-control" id="modeloMod" name="modeloMod">
								  </div>
								  <div class="mb-3">
								    <label for="Modelo" class="form-label">Fecha</label>
								    <input type="text" class="form-control" id="modeloMod" name="modeloMod">
								  </div>
