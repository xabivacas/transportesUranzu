			...
			<table class="table">
						...
						<c:forEach items="${viajes}" var="viaje" >
							<tr>
								...
								<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal${viaje.origen }+${viaje.destino}">
						...
						<!-- Modales -->
						<c:forEach items="${viajes}" var="viaje">
						<div class="modal fade" id="modal${viaje.origen }" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
